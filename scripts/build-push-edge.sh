...
docker build --tag catcamacr.azurecr.io/file-watcher:0.0.3-linux-arm32v7 -f EdgeModules/FileWatcher/Dockerfile.arm32v7 src
...
docker push catcamacr.azurecr.io/file-watcher:0.0.3-linux-arm32v7